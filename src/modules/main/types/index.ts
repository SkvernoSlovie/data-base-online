...
export interface DefaultFilters {
  ...
  unit_of_measuring: string | null;
  resource: number | null;
  lower_temperature_threshold: number | null;
  upper_temperature_threshold: number | null;
  ...
  power: string | null;
  measuring_channels: number | null;
}
...
export type DeviceFilters = Omit<
  SensorFilters,
  'sensitive_element' | 'output_signal' | 'signal_conversation' | 'measurable_value'
> & {
  purpose: string;
  control_type: string;
  measure_show_type: string;
